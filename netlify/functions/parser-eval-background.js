...
import { openaiAdapter, parseWhen } from "../../src/when.js";
import generated from "../../test/fixtures/hebrew-when-corpus-generated.json" with { type: "json" };
import { jevAdapter } from "../../src/jev.js";
import { evalProvider, evalLocal, evalCombo, evalHybrid } from "../../src/parser-eval.js";
...
export default async req=>{const auth=req.headers.get("authorization")||"";
 ...
 out.push({...await evalHybrid(parseWhen,corpus,CORPUS_NOW),provider:"hybrid_corpus100"});
 out.push({...await evalHybrid(parseWhen,generated,CORPUS_NOW),provider:"hybrid_generated"});
