...
export default async req=>{
 ...
 let body;try{body=JSON.parse(raw)}catch{return Response.json({error:"bad_json"},{status:400})}const store=netlifyStore(getStore({name:"gt-padel-matching",consistency:"strong"}));
