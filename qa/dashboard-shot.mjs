...
const [src = "netlify/functions/admin.js", out = "/tmp/dash.html", hash = "", tab = ""] = process.argv.slice(2);
...
const data = { summary: { registrations: users.length, activeRequests: 4, matches: 5, acceptedMatches: 3, bookingClicks: 3, verifiedBookings: 1, attributedRevenue: 300, incrementalCourtHours: 1.5 }, revenueBySource: { availability: 300, matching: 0 },
  ...
  open: [
   { requestId: "o1", kind: "open", type: "oneoff", when: "רביעי 23.9 · אחרי 21:00", nextDate: "2026-09-23", startMinute: 1260, level: "3–3.5", durations: [90], hasCourt: false, court: null, total: 1, full: false, participants: [{ userId: "972500000001", name: "תימור", party: 1, role: "owner" }], createdAt: "2026-09-23T14:52:42Z" },
   { requestId: "o2", kind: "open", type: "recurring", when: "כל רביעי · 19:00–23:00", nextDate: "2026-09-23", startMinute: 1140, level: "3–3.5", durations: [90], hasCourt: false, court: null, total: 1, full: false, participants: [{ userId: "972500000002", name: "אורנה", party: 1, role: "owner" }], createdAt: "2026-09-23T14:52:43Z" }],
  live: [
...
const tabJs = tab ? `<script>setTimeout(()=>{const b=document.querySelector('[data-v="${tab}"]');b&&b.click()},600)</script>` : "";
