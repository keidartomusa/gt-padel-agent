...
export const welcome=(name,venueName="גני תקווה")=>({text:(name?`*שלום ${name}, ברוכים הבאים ל־${venueName}* 🎾`:`*ברוכים הבאים ל־${venueName}* 🎾`)+"\n\nאני כאן כדי לעזור לכם להגיע למגרש ולמשחק שמתאים לכם.\n\n*1. למצוא מגרש פנוי*\nבדיקת זמינות חיה לפי יום, שעה ומשך - וקישור ישיר להזמנה.\n\n*2. למצוא שחקנים למשחק*\nחיפוש משחק נקודתי ליום ושעה מסוימים, או הרשמה עם הזמינות הקבועה שלכם - והמערכת מחפשת לכם התאמות באופן שוטף.\n\nמה תרצו לעשות?",buttons:[{id:"availability",title:"מגרש פנוי"},{id:"players",title:"מציאת שחקנים"}]});
